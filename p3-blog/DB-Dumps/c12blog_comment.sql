...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`),
  KEY `articleFK_idx` (`articleId`),
  KEY `authorFK_idx` (`authorId`),
  CONSTRAINT `articleFK` FOREIGN KEY (`articleId`) REFERENCES `article` (`id`),
  CONSTRAINT `authorFK` FOREIGN KEY (`authorId`) REFERENCES `user` (`id`)
